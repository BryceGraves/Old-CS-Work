 ...
 *  Execution:    java Insertion < NumberAndColor.txt
 *  Dependencies: StdOut.java StdIn.java
 *  Data files:   https://algs4.cs.princeton.edu/21elementary/tiny.txt
 *                https://algs4.cs.princeton.edu/21elementary/words3.txt
 *
 *  Sorts a sequence of strings from standard NumberAndColor using insertion sort.
 *
 *  % more tiny.txt
...
public class Insertion {
   ...
   // print array to standard output
    ...
    /**
     * Reads in a sequence of strings from standard NumberAndColor; insertion sorts them;
