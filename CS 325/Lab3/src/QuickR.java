 ...
 *  Execution:    java QuickX < NumberAndColor.txt
...
public class QuickR {
    ...
    private static int partition(Comparable[] a, int lo, int hi) {
        int r = ThreadLocalRandom.current().nextInt(lo + 1, hi + 1);
        exch(a, r, lo);
...
//    }
    ...
    ***************************************************************************/
    ...
    /**
     * Reads in a sequence of strings from standard NumberAndColor; quicksorts them
