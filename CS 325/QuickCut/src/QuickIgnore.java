...
public class QuickIgnore {
    ...
    public static void sort(Comparable[] a, int cutOff) {
        //StdRandom.shuffle(a);
        INSERTION_SORT_CUTOFF = cutOff;
        sort(a, 0, a.length - 1);
        Insertion.sort(a);
        assert isSorted(a);
    }

//    public static void sort(Comparable[] a, boolean shuffle) {
//        if (shuffle)
//            StdRandom.shuffle(a);
//        sort(a, 0, a.length - 1);
//        assert isSorted(a);
...
//        QuickCut.sort(a);
//
//        StdOut.printf("elapse time %f for %d elements\n", timer.elapsedTime(), a.length);
//    }
