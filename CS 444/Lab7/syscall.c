...
extern int sys_sem_inc(void);
extern int sys_sem_dec(void);
extern int sys_sem_status(void);
...
[SYS_sem_inc] sys_sem_inc,
[SYS_sem_dec] sys_sem_dec,
[SYS_sem_status] sys_sem_status,
};
